...
DECLARE
    ...
    CURSOR cur_solicitantes IS
        ...
        JOIN   SOLICITUD_CREDITO sc ON sc.numrun = ac.numrun;
...
BEGIN
    ...
    FOR sol IN cur_solicitantes LOOP
        ...
        BEGIN -- Bloque interno: un error en un solicitante no detiene el proceso completo
            ...
            INSERT INTO DETALLE_PUNTAJE_SOLICITUD
            ...
            INSERT INTO RESULTADO_SOLICITUD
        ...
        EXCEPTION
            WHEN OTHERS THEN
                INSERT INTO ERROR_PROCESO(id_error, rutina_error, descrip_error)
...
EXCEPTION
    WHEN OTHERS THEN
        ROLLBACK;
        INSERT INTO ERROR_PROCESO(id_error, rutina_error, descrip_error)
        VALUES (SEQ_ERROR.NEXTVAL, 'SP_CALCULO_PUNTAJE_PREAPROBACION',
