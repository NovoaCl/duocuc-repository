...
DECLARE
    ...
    -- variables del cursor (solo datos básicos del tipo)
    ...
    v_cantidad_emb       NUMBER(5);
    v_total_arriendos    NUMBER(6);
    v_total_dias         NUMBER(6);
    v_ingreso_total      NUMBER(14);
    v_clasificacion      VARCHAR2(15);

    -- cursor explícito SIN parámetros: SOLO id y nombre del tipo,
...
BEGIN
    ...
    LOOP
        ...
        --- negocio: total de arriendos y total de días del año 2025 (SELECT separado)
        ...
        --- negocio: ingreso total del año 2025 (SELECT separado)
        ...
        -- clasificación mediante estructura de control IF
...
DECLARE
    ...
    -- variables del cursor (solo datos básicos de la embarcación)
    ...
    v_total_dias          NUMBER(6);
    v_ingreso_arriendo    NUMBER(12);
    v_garantia_recaudada  NUMBER(12);
    v_ingreso_total       NUMBER(12);
    v_clasificacion       VARCHAR2(15);

    -- cursor explícito SIN parámetros: SOLO matrícula, tipo, valor de
    -- arriendo diario y valor de garantía diario; ordenado por matrícula
...
BEGIN
    ...
    LOOP
        ...
        --- negocio: nombre del tipo de embarcación (SELECT separado)
        SELECT nombre_tipo_emb
        INTO   v_nombre_tipo
        FROM   TIPO_EMBARCACION
        WHERE  id_tipo_emb = v_id_tipo_emb;

        --- negocio: cantidad de arriendos del año 2025 (SELECT separado)
        SELECT COUNT(*)
        ...
        --- negocio: total de días arrendados del año 2025 (SELECT separado)
        SELECT NVL(SUM(dias_solicitados), 0)
        INTO   v_total_dias
        FROM   ARRIENDO_EMBARCACION
        WHERE  matricula = v_matricula
        ...
        -- cálculos en PL/SQL, redondeados a entero
        ...
        -- clasificación de demanda mediante CASE (según cantidad de arriendos)
        v_clasificacion :=
            CASE
...
-- Verificación del resultado
SELECT * FROM INGRESO_EMBARCACION ORDER BY matricula;